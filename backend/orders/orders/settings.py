...
from backend.orders.orders.database_configs import get_database_config
...
SECRET_KEY = 'django-insecure-blzr)9z5y3kr%v$fi8k5f(rjy7_m=18hs@0r876k0@mwb-$yev'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'orders',  # This is your orders app
]
